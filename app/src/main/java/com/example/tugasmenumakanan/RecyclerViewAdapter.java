...
public class RecyclerViewAdapter extends  RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull  ViewHolder holder, @SuppressLint("RecyclerView") final int position){
        ...
        holder.textViewHargaMakanann.setText(hargaMakanan.get(position));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView textViewHargaMakanann;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            imageViewFotoMakanan = itemView.findViewById(R.id.imageViewFotoMakanan);
            textViewHargaMakanann = itemView.findViewById(R.id.textViewHargaMakanan);
